...
You're able to configure the settings in-game with the command /battle settings or via the config file. **Keep in mind that you aren't able to configure the loot chests with commands.** The configurable settings are:
